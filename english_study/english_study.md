...
The company's database was corrupted,resulting in fragments（碎片） of data scattered throughout the system.
...
=====================================================================
The figure shows the growth of the company's profits over the past year.  finger(指头)
